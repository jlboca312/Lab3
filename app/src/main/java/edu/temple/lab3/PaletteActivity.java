...
public class PaletteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //array of colors to be in list view
        String[] colorArr = {"lightGray", "Red", "Yellow", "Green", "Cyan"};

        //create a custom adapter for the spinner to have the color array
        ColorAdapter colorAdapter = new ColorAdapter(PaletteActivity.this, android.R.layout.simple_spinner_dropdown_item, colorArr);
